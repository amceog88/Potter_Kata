...
describe Cart do
  ...
  context "第四種情境：打 15% 折扣" do
    ...
    it "第一集買 2 本、第二集買 2 本、第三集買 3 本、第四集買 3 本" do
      @cart.add({ "1st": 2, "2nd": 2, "3rd": 3, "4th": 3, "5th": 0 })
      expect(@cart.calculate).to eq(870)
    end
    ...
    it "第一集買 2 本、第二集買 3 本、第三集買 3 本、第四集買 3 本" do
      @cart.add({ "1st": 2, "2nd": 3, "3rd": 3, "4th": 3, "5th": 0 })
      expect(@cart.calculate).to eq(950)
    end
  ...
  context "第五種情境：打 20% 折扣" do
    ...
    it "第一集買 2 本、第二集買 2 本、第三集買 2 本、第四集買 3 本、第五集買 3 本" do
      @cart.add({ "1st": 2, "2nd": 2, "3rd": 2, "4th": 3, "5th": 3 })
      expect(@cart.calculate).to eq(990)
    end

    it "第一集買 2 本、第二集買 2 本、第三集買 3 本、第四集買 3 本、第五集買 3 本" do
      @cart.add({ "1st": 2, "2nd": 2, "3rd": 3, "4th": 3, "5th": 3 })
      expect(@cart.calculate).to eq(1070)
    end

    it "第一集買 2 本、第二集買 3 本、第三集買 3 本、第四集買 3 本、第五集買 3 本" do
      @cart.add({ "1st": 2, "2nd": 3, "3rd": 3, "4th": 3, "5th": 3 })
      expect(@cart.calculate).to eq(1140)
    end

    it "第一集買 2 本、第二集買 3 本、第三集買 3 本、第四集買 4 本、第五集買 4 本" do
      @cart.add({ "1st": 2, "2nd": 3, "3rd": 3, "4th": 4, "5th": 4 })
